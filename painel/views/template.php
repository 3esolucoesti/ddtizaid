...
<head>
    ...
    <style type="text/css">
        ...
        .barraInit .btn_Small:hover {
            background: <?php echo COR_HOLVER; ?>;
        }

        .barraInit .btn_smallMenu {
            cursor: pointer;
        }
        ...
        .listNavBar ul li .fa-caret-down {
            float: right;
            margin-top: 3px;
        }
        ...
        .listNavBar ul li a:hover {
            ...
            background: <?php echo COR_MARCACAO; ?>;
        }
        ...
        .listNavBar ul li ul li {
            padding-left: 15px;
        }

        .listNavBar ul li ul li a {
            border-bottom: 1px solid <?php echo COR_HOLVER; ?>;
        }
        ...
        .areaNotificacoes a .badge1 {
            background: blue;
            margin-right: 10px;
        }

        .areaNotificacoes a .badge2 {
            background: green;
        }
        ...
        .listaBtnPerfil .btn_Perfil {
            margin-left: 10px;
        }

        .listaBtnPerfil .trocaUser {
            margin-left: 10px;
        }

        .listaBtnPerfil .btnSair {
            margin-left: 10px;
        }
        ...
        .fotoPessoaAtual {
            ...
            border-radius: 100%;
            background: red;
            border: 2px solid <?php echo COR_HOLVER; ?>;
            margin: auto;
        }
            ...
            <div class="areaLogo">
                <div class="logoEmpresa">
                    <a href="<?= BASE_URL; ?>/painel">
                        <img src="<?= BASE_URL; ?>/painel/assets/images/TEMPLATE/<?= $viewData['company_logo']; ?>" alt="" style="width: 40px; height: auto; margin: 6px 0 0 1px;" />
                    </a>
                </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <center>
                            <h4 class="modal-title">ACESSE OUTRA CONTA</h4>
                        </center>
                    </div>
                    <div class="modal-body">
