...
<div class="container-fluid">
	<div class="loginarea">
    	...
    	<form method="post" class="form">
            ...
            <input type="submit" value="Entrar" class="btn btn-default"><a href="<?php echo BASE_URL; ?>/painel/login/newpass" class="esqueciminhasenha">Esqueci minha senha</a>
                        <br><br>
            <center><a href="<?php echo BASE_URL; ?>/" class="btn btn-success" >VOLTAR PARA O SITE</a></center>
        </form>
    </div>
</div>
