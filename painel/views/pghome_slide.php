...
<style type="text/css" media="screen">
	body {
		background-color: #c28630 !important;
	}
...
<body style="background-color: #e9e9e9;">
	...
	<div class="container-fluid" style="margin:0px;padding: 0px;">
		...
		<!-- Modal adicionar -->
		<div id="addSlide" class="modal fade" role="dialog" data-backdrop="static">
			<div class="modal-dialog modal-lg">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<h3>Adicionar novo slide</h3><br>
						<form method="POST" enctype="multipart/form-data">

							<label>Escolher Imagem:</label> <strong style="color: red;font-size: .9em;">( OBS: TAMANHO MÁXIMO 1MB / 1150px X 400px )</strong>
		...
		<div class="modal fade" id="deleteSlide" data-backdrop="static" role="dialog" style="position: fixed;">
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					<div class="modal-body">
						<center>
			...
			<table class="table table-bordered">
				...
				<tbody>
					<?php foreach ($list_slide as $slide) : ?>
						<tr>
							<td><img src="<?= BASE_URL; ?>/painel/assets/images/<?= $slide['images80']; ?>" class="imgTable" style="border:2px solid #e9e9e9;border-radius: 5px;" border="0" alt=""/></td>
							<td>
								<center>
