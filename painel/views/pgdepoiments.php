...
<body style="background-color: #e9e9e9;">
	...
	<div class="container-fluid" style="margin:0px;padding: 0px;">
		...
		<!-- Modal Deletar -->
		<div class="modal fade" id="deleteDepoi" data-backdrop="static" role="dialog" style="position: fixed;z-index: 999999;">
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					<div class="modal-body">
						<center>
		...
		<!-- Modal Adicionar -->
		<div id="addDepoi" class="modal fade" role="dialog" data-backdrop="static">
			<div class="modal-dialog modal-lg">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<br>
						<h3>Adicionar novo depoimentos</h3><br>
			...
			<div class="modal-dialog modal-lg">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<br>
						<h3>Editar novo depoimento</h3><br>
			...
			<table class="table table-bordered">
				...
				<tbody>
					<?php foreach ($list_depo as $depo) : ?>
						<tr>
							<td><img src="<?= BASE_URL; ?>/painel/assets/images/<?= $depo['images120']; ?>" class="imgTable" alt="" /></td>
							<td><?= $depo['name']; ?></td>
