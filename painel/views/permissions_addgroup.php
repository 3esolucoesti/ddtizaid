...
<form method="post" class="form">
	...
	<?php foreach($permissions_list as $p): ?>
		...
		<label><input style="float: left;margin-top: 2px;" type="checkbox" class="permissions" name="permissions[]" value="<?php echo $p['id']; ?>" /><?php echo '&nbsp;'.utf8_encode($p['name_apresentar']); ?></label><br/>
	<?php endforeach; ?>
